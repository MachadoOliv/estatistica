# --- Exemplo 1 Dados de temperatura de cada sensor (25 leituras no total)
...
# Média comum:
media_a  = sum(sensor_a_data) / len(sensor_a_data)
print(media_a)
...
print(f"Média Arimética Simples das Temperaturas: {media_simples:.2f}")
print("*******")
...
proporcao_populacao_ativa = 0.70 # 70% de todos são ativos 
proporcao_populacao_ocasional = 0.30 #30% de todos são ocasionais
...
print(f"proporção usúarios ativos na amostra: {proporcao_ativa_amostra}")
print(f"proporçao usuários ocasionais na amostra: {proporcao_ocasional_amostra}")

peso_ativos_balanceado = proporcao_populacao_ativa / proporcao_ativa_amostra
peso_ocasionais_balanceado = proporcao_populacao_ocasional / proporcao_ativa_amostra
...
print(f"Média Ponderada da Satisfação do usuário: {media_simples:.2f}")
